...
public:
	...
	chat_command_handler(chat_handler& chathandler, bool allies_only)
		: map()
		, chat_handler_(chathandler)
		, allies_only_(allies_only)
	{
	}
...
protected:
	...
	void init_map()
	{
		...
		register_command("unban", &chat_command_handler::do_network_send_req_arg,
			...
			_("<nickname>"));
		register_command(
			"kick", &chat_command_handler::do_network_send_req_arg, _("Kick a player or observer."), _("<nickname>"));
		...
		register_command(
			"muteall", &chat_command_handler::do_network_send, _("Mute/Unmute all observers. (toggles)"), "");
		...
		register_command(
			"emote", &chat_command_handler::do_emote, _("Send an emotion or personal action in chat."), _("<message>"));
		...
		register_command(
			"log", &chat_command_handler::do_log, _("Change the log level of a log domain."), _("<level> <domain>"));
		register_command(
			"ignore", &chat_command_handler::do_ignore, _("Add a nickname to your ignores list."), _("<nickname>"));
		register_command(
			"friend", &chat_command_handler::do_friend, _("Add a nickname to your friends list."), _("<nickname>"));
		...
		register_command("version", &chat_command_handler::do_version, _("Display version information."));
		register_command(
			"info", &chat_command_handler::do_info, _("Request information about a nickname."), _("<nickname>"));
		register_command("clear", &chat_command_handler::do_clear_messages, _("Clear chat history."));
	}

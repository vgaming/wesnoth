...
public:
	...
	*/
	 ...
	 */
	const time_of_day get_illuminated_time_of_day(
		const unit_map& units, const gamemap& map, const map_location& loc, int for_turn = 0) const;
...
private:
	 ...
	 */
	const time_of_day& get_time_of_day_turn(

...
editor_edit_label::editor_edit_label(
	std::string& text, bool& immutable, bool& visible_fog, bool& visible_shroud, color_t& color, std::string& category)
...
{
	register_integer(widget_id, true, std::bind(&editor_edit_label::load_color_component, this, component),

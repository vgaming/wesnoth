...
extern bool debug_lua, strict_lua, editor, ignore_replay_errors, mp_debug, exit_at_end, disable_autosave, no_addons;
...
extern std::string title_music, lobby_music;
...
namespace images
{
extern std::string game_title, game_title_background, game_logo, game_logo_background, victory_laurel,
	victory_laurel_hardest, victory_laurel_easy,
	// orbs and hp/xp bar
	...
	// GUI elements
	observer, tod_bright, tod_dark, selected_menu, deselected_menu, checked_menu, unchecked_menu, wml_menu, level,
	ellipsis, missing, blank,
	// notifications icon
	app_icon;
} // namespace images
...
namespace sounds
{
extern std::string turn_bell, timer_bell, public_message, private_message, friend_message, server_message, player_joins,
	player_leaves, game_user_arrive, game_user_leave, ready_for_start, game_has_begun, game_created;
extern const std::string button_press, checkbox_release, slider_adjust, menu_expand, menu_contract, menu_select;
namespace status
{

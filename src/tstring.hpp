...
inline std::size_t hash_value(const t_string_base& str)
{
...
public:
	...
	{
		return t_string(base::from_serialized(string));
	}
	std::string to_serialized() const
	{
		return get().to_serialized();
	}
...
inline std::ostream& operator<<(std::ostream& os, const t_string& str)
{
	return os << str.get();
}
...
inline bool operator==(const char* a, const t_string& b)
{
	return b == a;
}
inline bool operator!=(const std::string& a, const t_string& b)
...
inline t_string operator+(const std::string& a, const t_string& b)
{
	return t_string(a) + b;
}
inline t_string operator+(const char* a, const t_string& b)
{
	return t_string(a) + b;
}

...
public:
	...
	/** Reset the internal unit pointer, and deregister from the manager. This fake_unit_ptr is now dissassociated from
	 * the manager. */
	void reset();
	/** Reset the internal unit pointer and point to a new unit. The old unit is deregistered, and the new unit is
	 * registered with the old manager, if there was one. */

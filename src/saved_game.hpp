...
public:
	 ...
	 * This should be called before expanding carryover or mp_events because this might completely replace
	 * starting_point_.
	 */
	...
	/** @return the starting pos for replays. Usually this is [replay_start] but it can also be a [scenario] if no
	 * [replay_start] is present */
	const config& get_replay_starting_point();
	/** @return the id of the currently played scenario or the id of the next scenario if this is a
	 * between-scenaios-save (also called start-of-scenario-save). */
...
private:
	...
	/**
		...
		if true:  The carryover information for all sides from the previous scenario that aren't used in this scenario
	   (to be carried over to the next scenario). if false: The carryover information for all sides from the previous
	   scenario.
	*/
	config carryover_;

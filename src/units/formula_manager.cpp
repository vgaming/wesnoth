...
{
	unit_formula_ = ai.get_deprecated_attribute(
						  "formula", "unit][ai", DEP_LEVEL::FOR_REMOVAL, "FormulaAI will be removed in 1.17")
						.str();
	unit_loop_formula_ = ai.get_deprecated_attribute(
							   "loop_formula", "unit][ai", DEP_LEVEL::FOR_REMOVAL, "FormulaAI will be removed in 1.17")
							 .str();
	unit_priority_formula_ = ai.get_deprecated_attribute(
								   "priority", "unit][ai", DEP_LEVEL::FOR_REMOVAL, "FormulaAI will be removed in 1.17")
								 .str();

	if(auto ai_vars
		= ai.get_deprecated_child("vars", "unit][ai", DEP_LEVEL::FOR_REMOVAL, "FormulaAI will be removed in 1.17")) {
		formula_vars_ = std::make_shared<wfl::map_formula_callable>();

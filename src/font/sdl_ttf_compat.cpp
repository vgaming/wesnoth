...
texture pango_render_text(const std::string& text,
	int size,
	const color_t& color,
...
std::string pango_word_wrap(const std::string& unwrapped_text,
	int font_size,
	int max_width,
	int max_height,
	int max_lines,
...
rect pango_draw_text(bool actually_draw,
	const rect& area,
	int size,
	const color_t& color,
